...
<div class="inner-repeater">
    <div data-repeater-list="barang">
      <div data-repeater-item class="border rounded p-4 mb-4 bg-white shadow-sm">
  
        <div class="row g-3 align-items-center mb-3">
          <div class="col-md-3">
            <select data-type="tipe" name="tipe_id" class="form-select form-select-sm tipe_id" data-kt-repeater="select2" data-placeholder="Pilih tipe/jenis brand"></select>
          </div>
          <div class="col-md-3">
            <input type="text" name="nama" class="form-control form-control-sm" placeholder="Nama Item (Tetap)">
          </div>
          <div class="col-md-2">
            <select data-type="satuan" name="satuan_id" class="form-select form-select-sm satuan_id" data-kt-repeater="select2" data-placeholder="Pilih satuan"></select>
          </div>
          <div class="col-md-2">
        ...
        <!-- === SUB-REPEATER UNTUK KODE ITEM & SIZE === -->
        <div class="sub-repeater mt-4 border-top pt-3">
          <label class="form-label fw-bold">Variasi Kode & Size</label>
          <div data-repeater-list="variasi">
            <div data-repeater-item class="row g-3 align-items-center mb-2">
              <div class="col-md-3">
          ...
          <button type="button" data-repeater-create class="btn btn-sm btn-light-primary">+ Tambah Kode & Size</button>
        </div>
        <!-- === END SUB REPEATER === -->
