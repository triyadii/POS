...
@section('content')
                ...
                <div class="card border border-dashed border-dark card-flush h-xl-100 d-none mt-5" id="table-wrapper">
                    ...
                    <div class="card-body pt-5">
                        <div class="table-responsive">
                            <table class="table align-middle table-row-dashed fs-8 gy-5" id="chimox_kategori_table">
                                <thead>
    ...
    <div class="modal fade" tabindex="-1" id="modal_detail_penjualan_kategori">
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#modal_detail_penjualan_kategori').on('show.bs.modal', function(event) {
                    ...
                    if (Array.isArray(details) && details.length > 0) {
                        ...
                        contentHtml +=
                            '<tr><td colspan="4" class="text-center">Tidak ada item detail untuk kategori yang difilter.</td></tr>';
                    }
