        ...
        <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-900">Kategori List</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 w-100 chimox" id="chimox">
                    <thead>
                        <tr class="fw-bold text-muted fs-7 text-uppercase gs-0">                            
                            ...
                            @canany(['kategori-show', 'kategori-edit', 'kategori-delete'])
                        ...
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="nama" id="nama"
                                    class="form-control mb-3 mb-lg-0" placeholder="Nama Kategori" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="keterangan" id="keterangan"
                                    class="form-control mb-3 mb-lg-0" placeholder="keterangan kategori" />
...
<div class="modal fade" id="modalShowKategori" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content rounded-3 shadow">
        ...
        <div class="modal-body" id="modalShowKategoriBody">
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.btn-show-kategori', function(e) {
            e.preventDefault();
    
            let id = $(this).data('id');
            let modal = new bootstrap.Modal(document.getElementById('modalShowKategori'));
            let body = $('#modalShowKategoriBody');
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                var canShow = @json(auth()->user()->can('kategori-show'));
                var canEdit = @json(auth()->user()->can('kategori-edit'));
                var canDelete = @json(auth()->user()->can('kategori-delete'));
                var canMassDelete = @json(auth()->user()->can('kategori-massdelete'));
                    ...
                    if (selectedIds.length > 0) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('kategori.mass-delete') }}", // Pastikan route ini ada
                                    type: 'POST',
                                    data: {
                                        ids: selectedIds,
