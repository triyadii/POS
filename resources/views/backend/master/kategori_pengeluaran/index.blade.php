    ...
    <div id="kt_app_toolbar" class="app-toolbar d-flex flex-stack py-4 py-lg-8">
        ...
        <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Kategori Pengeluaran
                    List</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-900">Kategori Pengeluaran List</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="d-flex align-items-center pt-4 pb-7 pt-lg-1 pb-lg-2">
                ...
                <!--end::Wrapper-->
                <!--begin::Button-->
                @can('kategori-pengeluaran-create')
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 w-100 chimox" id="chimox">
                    <thead>
                        <tr class="fw-bold text-muted fs-7 text-uppercase gs-0">                            
                            @can('kategori-pengeluaran-massdelete')
                            ...
                            @endcan
                            <th class="min-w-125px">Nama Kategori Pengeluaran</th>
                           
                            <th class="min-w-100px">Deskripsi</th>
                            @canany(['kategori-pengeluaran-show', 'kategori-pengeluaran-edit', 'kategori-pengeluaran-delete'])
                        ...
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="nama" id="nama"
                                    class="form-control mb-3 mb-lg-0" placeholder="Nama Kategori Pengeluaran" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="keterangan" id="keterangan"
                                    class="form-control mb-3 mb-lg-0" placeholder="keterangan " />
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content rounded-3 shadow">
        <div class="modal-header bg-light">
          <h5 class="modal-title fw-bold">Detail Kategori Pengeluaran</h5>
        ...
        <div class="modal-body" id="modalShowBrandBody">
          <div class="text-center py-10 text-muted">
            ...
            <p class="mt-3">Memuat data kategori pengeluaran...</p>
          </div>
        </div>
      </div>
    </div>
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.btn-show-kategori-pengeluaran', function(e) {
            e.preventDefault();
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                var canShow = @json(auth()->user()->can('kategori-pengeluaran-show'));
                var canEdit = @json(auth()->user()->can('kategori-pengeluaran-edit'));
                var canDelete = @json(auth()->user()->can('kategori-pengeluaran-delete'));
                var canMassDelete = @json(auth()->user()->can('kategori-pengeluaran-massdelete'));
                ...
                var table = $('.chimox').DataTable({
                    ...
                    order: false,
                    ajax: {
                        url: "{{ route('get-kategori-pengeluaran') }}",
                        type: 'GET',
                        data: function(d) {}
                    },
                    columns: [
                ...
                $('body').on('click', '#getEditRowData', function(e) {
                    ...
                    id = $(this).data('id');
                    $.ajax({
                        url: "kategori-pengeluaran/" + id + "/edit",
                        dataType: "json",
                        success: function(result) {
                            console.log(result);
                    ...
                    if (selectedIds.length > 0) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('kategori-pengeluaran.mass-delete') }}", // Pastikan route ini ada
                                    type: 'POST',
                                    data: {
                                        ids: selectedIds,
