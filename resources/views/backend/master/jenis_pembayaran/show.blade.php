...
<input type="hidden" name="hidden_id" id="hidden_id" value="{{ $data->id }}" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="nama" id="Editnama"
                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama Pembayaran" value="{{$data->nama}}" readonly/>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="no_rekening" id="Editno_rekening"
                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder="No. Rekening" value="{{$data->no_rekening}}" readonly/>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="nama_pemilik" id="Editnama_pemilik"
                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama Pemilik" value="{{$data->nama_pemilik}}" readonly/>
